...
public class recieveList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayoutManager = new LinearLayoutManager(recieveList.this);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<PhotosData, Toiletring.ToiletDataViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<PhotosData, Toiletring.ToiletDataViewHolder>(

                PhotosData.class,
                R.layout.child_row,
                Toiletring.ToiletDataViewHolder.class,
                DatabaseCommenttttt
        ) {
            @Override
            protected void populateViewHolder(Toiletring.ToiletDataViewHolder viewHolder, PhotosData model, int position) {
                ...
                viewHolder.mLinearName.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent userProfile=new Intent(recieveList.this,recieveNotification.class);
